...
<!-- HEALTH:BEGIN -->
_Measured automatically by [`scripts/health-check.mjs`](scripts/health-check.mjs), re-run daily by [the health workflow](.github/workflows/health.yml). Last run: **2026-09-08T09:45Z** · probe query `PCR purification` (`EcoRI` for REBASE)._
...
❌ The full-catalog sweep failed: [labee-protocol-searcher] network: unknown (no network signals available)
