...
<!-- HEALTH:BEGIN -->
_Measured automatically by [`scripts/health-check.mjs`](scripts/health-check.mjs), re-run daily by [the health workflow](.github/workflows/health.yml). Last run: **2026-09-21T10:55Z** · probe query `PCR purification` (`EcoRI` for REBASE)._
...
| `jove` | ⚠️ fallback · `crossref+openalex` | ⚠️ partial | ✅ 5 | ⚠️ `not-found` · not indexed |
| `bio-protocol` | ✅ AWS Browserless | ✅ full | ✅ 2 | ✅ `ok` |
| `current-protocols` | ⚠️ fallback · `crossref+europepmc+openalex+pubmed` | ⚠️ partial | ✅ 10 | ⚠️ `not-found` · not indexed |
...
**Per-DOI retrieval:** 5/17 returned full text in this run. Not persisted: the result depends on the network the probe ran from, so it is reported, not published as a fact.
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-09-21 | ⚠️ 5/6 | ⚠️ 11/15 | ⚠️ 15/16 | ⚠️ 12/16 | `semanticscholar` | `sigma-aldrich`, `emd-millipore` |
| 2026-09-20 | ⚠️ 5/6 | ⚠️ 12/15 | ⚠️ 15/16 | ⚠️ 14/16 | `semanticscholar` | `sigma-aldrich`, `emd-millipore` |
