...
<!-- HEALTH:BEGIN -->
_Measured automatically by [`scripts/health-check.mjs`](scripts/health-check.mjs), re-run daily by [the health workflow](.github/workflows/health.yml). Last run: **2026-09-07T10:23Z** · probe query `PCR purification` (`EcoRI` for REBASE)._
...
| `nature-protocols` | ⚠️ partial | ✅ 13 | ⚠️ `abstract-only` · Europe PMC abstract |
