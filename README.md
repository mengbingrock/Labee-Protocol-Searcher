...
<!-- HEALTH:BEGIN -->
_Measured automatically by [`scripts/health-check.mjs`](scripts/health-check.mjs), re-run daily by [the health workflow](.github/workflows/health.yml). Last run: **2026-09-18T23:42Z** · probe query `PCR purification` (`EcoRI` for REBASE)._
...
❌ The full-catalog sweep failed: [labee-protocol-searcher] network: commercial 145.132.101.192 (network operator "AS8075 Microsoft Corporation")

probe exceeded 60000ms
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-09-18 | ⚠️ 5/6 | — | ❌ sweep failed | — | `semanticscholar` | — |
