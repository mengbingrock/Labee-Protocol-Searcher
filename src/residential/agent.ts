...
import { AgentHandshake, SecureChannel } from './secure-channel.ts';
import {
...
import { createControlProxyAgent } from './control-proxy.ts';
...
export class ResidentialProxyAgent {
  ...
  protected readonly controlProxy: string | undefined;
  protected readonly legacyPlaintext: boolean;
  protected channel: SecureChannel | undefined;
  protected handshake: AgentHandshake | undefined;
